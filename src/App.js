  ...
  constructor(props) {
    ...
    this.state = {
      stocks: [
        ...
        {name: "Microsoft Corporation", symbol: "MSFT", lastPrice: 64.98, change: 0.109999999999999,hig: 65.45, low: 64.76, open: 65.12},
    ...
    return(
      <Router>
        <div>
          <nav>
            <div className="nav">
              <div className="nav-item"><span className="nav-logo">StocksNow</span></div>
